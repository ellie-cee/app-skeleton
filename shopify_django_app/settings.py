...
CORS_ALLOWED_ORIGINS = [
    f'https://{os.getenv("SHOPIFY_DOMAIN")}',
    f'https://{os.getenv("SHOPIFY_CORS_DOMAIN")}',
    f'https://www.{os.getenv("SHOPIFY_CORS_DOMAIN")}',
]
...
MIDDLEWARE = [
    ...
    'shopify_app.middleware.ShopifyEmbed'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.share_env',
