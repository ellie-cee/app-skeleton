class JSONEditor {
    ...
    select_tab(index) {
        ...
        document.querySelectorAll(".srd-json-object").forEach(content=>content.classList.remove("active"));
        document.querySelectorAll(".item-tab").forEach(content=>content.classList.remove("active"));
        try {
            document.querySelector(`.srd-json-object[data-index="${index}"]`).classList.add("active");
...
class RootNode  {
    ...
    render() {
        return `
            <div class="srd-json-object" data-index="${this.index}">
                <div style="display:flex">
                    
                    <div class="form">
                        <div class="srd-form-row options">
    ...
    renderPreview() {
        ...
        document.querySelector(`.srd-json-object[data-index="${this.index}"] .preview`)
    ...
    setupEvents() {
        ...
        document.querySelector(`.srd-json-object[data-index="${this.index}"] .js-new-field`)
...
class FormRow  {
    ...
    render() {
        return `
            <div class="srd-form-row even_odd" data-index="${this.index}" data-uuid="${this.uuid}">
...
class NutritionFormRow extends FormRow {
    ...
    render() {
        ...
        return `
            ...
            <div class="srd-form-row" data-index="${this.index}" >
...
class NutritionFacts extends FormRow {
    ...
    render() {
        return `
            <div class="srd-form-nutrition-facts ${this.constructor.name.toLowerCase()}" data-index="${this.index}" data-uuid="${this.uuid}">
